...
function PastYear({ data }: { data: [anime] }) {
  ...
  return (
    ...
    >
      ...
      <div className="rating z-40 hover:scale-110 duration-300 ease-in text-xs md:text-base text-white w-12 h-12 md:w-16 md:h-16 rounded-full bg-gray-900 absolute top-28 md:top-24 left-5 gap-1 outline outline-slate-200 outline-solid flex justify-center items-center">
