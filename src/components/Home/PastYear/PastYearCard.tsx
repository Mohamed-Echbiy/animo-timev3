...
function PastYearCard({ data }: { data: anime | recommndation }) {
  return (
    <div className="PastYearCard relative">
      ...
      <div className=" relative group min-w-[150px]  aspect-[.7]  flex-grow border-8 border-solid border-gray-900 text-xs lg:text-sm text-white shadow-primary shadow-gray-500">
